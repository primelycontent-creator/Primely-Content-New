    ...
    <div className="min-h-[calc(100vh-120px)] px-4 py-10">
      <div className="mx-auto max-w-4xl rounded-3xl border bg-white/80 p-8 shadow-sm md:p-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-7 text-gray-600 md:text-base">
          Please choose the legal document that matches your account type.
        </p>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Terms that apply to companies, clients and campaign owners using the platform.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Terms that apply to creators, profile verification and content workflow usage.
            </p>
          </Link>
        </div>
      </div>
